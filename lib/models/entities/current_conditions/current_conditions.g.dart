...
CurrentConditions _$CurrentConditionsFromJson(
  ...
  realFeelTemperature: json['RealFeelTemperature'] == null
      ? null
      : UnitValue.fromJson(json['RealFeelTemperature'] as Map<String, dynamic>),
  ...
  past24HourTemperatureDeparture: json['Past24HourTemperatureDeparture'] == null
      ? null
      : UnitValue.fromJson(
  ...
  apparentTemperature: json['ApparentTemperature'] == null
      ? null
      : UnitValue.fromJson(json['ApparentTemperature'] as Map<String, dynamic>),
  ...
  wetBulbTemperature: json['WetBulbTemperature'] == null
      ? null
      : UnitValue.fromJson(json['WetBulbTemperature'] as Map<String, dynamic>),
