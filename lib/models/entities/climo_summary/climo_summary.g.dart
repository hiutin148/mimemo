...
Actuals _$ActualsFromJson(Map<String, dynamic> json) => Actuals(
  temperatures: json['Temperatures'] == null
      ? null
      : UnitValueRange.fromJson(json['Temperatures'] as Map<String, dynamic>),
  degreeDays: json['DegreeDays'] == null
      ? null
