...
import 'package:mimemo/ui/widgets/visibility_detector/render_visibility_detector.dart';
...
class VisibilityDetector extends SingleChildRenderObjectWidget {
  ...
  RenderVisibilityDetector createRenderObject(BuildContext context) {
    return RenderVisibilityDetector(key: key!, onVisibilityChanged: onVisibilityChanged);
  }
...
class SliverVisibilityDetector extends SingleChildRenderObjectWidget {
  ...
  RenderSliverVisibilityDetector createRenderObject(BuildContext context) {
    return RenderSliverVisibilityDetector(key: key!, onVisibilityChanged: onVisibilityChanged);
  }
...
class VisibilityInfo {
  ...
  factory VisibilityInfo.fromRects({
    ...
    final visibleBounds =
        overlaps ? widgetBounds.intersect(clipRect).shift(-widgetBounds.topLeft) : Rect.zero;
