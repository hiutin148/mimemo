...
import 'package:mimemo/ui/widgets/visibility_detector/visibility_detector.dart';
import 'package:mimemo/ui/widgets/visibility_detector/visibility_detector_controller.dart';
...
class RenderVisibilityDetector extends RenderProxyBox
  ...
  RenderVisibilityDetector({
    required this.key, required VisibilityChangedCallback? onVisibilityChanged, RenderBox? child,
  })  : super(child) {
